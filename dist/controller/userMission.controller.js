...
let UserMissionController = class UserMissionController {
     ...
     * 미션 도전 API
     */
    challengeMissionController(missionId) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const result = yield (0, userMission_service_1.challengeMission)(missionId);
                return {
                    isSuccess: true,
                    code: "COMMON201",
                    message: "미션 도전 성공",
    ...
    getMyInProgressMissionsController() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const missions = yield (0, userMission_service_1.getMyInProgressMissions)();
                return {
                    isSuccess: true,
                    code: "COMMON200",
     ...
     * 미션 완료 처리 API
     */
    completeMissionController(missionId) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const result = yield (0, userMission_service_1.completeMission)(missionId);
                return {
                    isSuccess: true,
                    code: "COMMON200",
                    message: "미션 완료 처리 성공",
